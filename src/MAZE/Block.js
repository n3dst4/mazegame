(function($, global){
    ...
    var wallMaterial = new THREE.MeshPhongMaterial({
            color: 0xffffff,
            map: THREE.ImageUtils.loadTexture('images/bunker/metal_wall_10_r.jpg', {}, function() {})
        }),
        floorMaterial = new THREE.MeshPhongMaterial({
            color: 0xffffff,
            map: THREE.ImageUtils.loadTexture('images/bunker/metal_floor_01_r.jpg', {}, function() {})
        }),
        ceilingMaterial = new THREE.MeshPhongMaterial({
            color: 0xffffff,
            map: THREE.ImageUtils.loadTexture('images/bunker/metal_base_03_r.jpg', {}, function() {})
        }),    
